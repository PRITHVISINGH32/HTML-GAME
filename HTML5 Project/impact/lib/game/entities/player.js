...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        ...
        update: function(){
            ...
            if(ig.input.state('left')){ this.accel.x = -accel; this.flip = true; }
            ...
            if(ig.input.pressed('switch')){
                ...
                switch(this.weapon){
                    case(0): this.activeWeapon = "EntityBullet"; break;
                    case(1): this.activeWeapon = "EntityGrenade"; break;
                }
                this.setupAnimation(this.weapon);
            }
    ...
    EntityGrenade = ig.Entity.extend({
        ...
        handleMovementTrace: function(res){
            ...
            if(res.collision.x || res.collision.y){
                this.bounceCounter++;
                if(this.bounceCounter > 3) this.kill();
            }
        },
        check: function(other){
